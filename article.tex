...
\item $\lambda f. \lambda x. {\bf let \: pure} \: \langle g, y \rangle = \langle f, x \rangle {\: \bf in \:} g y : {\bf K}(A \to B) \to {\bf K} A \to {\bf K} B$
\item $\lambda f. \lambda x. {\bf let \:pure} \: \langle g, y \rangle = \langle {\bf pure \:} f, x \rangle {\: \bf in \: } g y : (A \to B) \to {\bf K} A \to {\bf K} B$
\end{itemize}
...
Strong normalization and colfuence for ${\bf IK}$ was proved by Kakutani for call-by-value and for call-by name \cite{ModalK} \cite{ModalK1}.
