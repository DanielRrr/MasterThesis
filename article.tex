...
& [q, {\bf let \: pure \:} z = q {\: \bf in \:} \langle \pi_1 (\pi_1 z), \langle \pi_2 (\pi_1 z), \pi_2 z \rangle \rangle] \circ [p, {\bf let \: pure \:} x, y = {\bf pure \:}(\pi_1 p), \pi_2 {\: \bf in \:} \langle x, y \rangle ] = & \\
& [p, {\bf let \: pure \:} z = q {\: \bf in \:} \langle \pi_1 (\pi_1 z), \langle \pi_2 (\pi_1 z), \pi_2 z \rangle \rangle [q := {\bf let \: pure \:} x, y = {\bf pure \:}(\pi_1 p), \pi_2 {\: \bf in \:} \langle x, y \rangle]] = & \\
& [p, {\bf let \: pure \:} z = ({\bf let \: pure \:} x, y = {\bf pure \:}(\pi_1 p), \pi_2 {\: \bf in \:} \langle x, y \rangle) {\: \bf in \:} \langle \pi_1 (\pi_1 z), \langle \pi_2 (\pi_1 z), \pi_2 z \rangle \rangle] = & \\
& [p, {\bf let \: pure \:} x, y = {\bf pure \:}(\pi_1 p), \pi_2 {\: \bf in \:} \langle \pi_1 (\pi_1 z), \langle \pi_2 (\pi_1 z), \pi_2 z \rangle \rangle [z := x, y]] = & \\
& [p, {\bf let \: pure \:} x, y = {\bf pure \:}(\pi_1 p), \pi_2 {\: \bf in \:} \langle \pi_1 x, \langle \pi_2 x, y \rangle \rangle]&
\end{array}$
\end{proof}
