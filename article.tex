...
\begin{defin}
  ...
  \begin{itemize}
  \item $\eta : Id_{\mathcal{C}(\lambda)} \to \mathcal{K}$, such that forall $A \in Ob_{\mathcal{C}(\lambda)}$, $\eta_A = [x, {\bf pure \:} x] \in Hom_{\mathcal{C}(\lambda)}(A, {\bf K}A)$;
